/*
    RHS Armed Forces of the Russian Federation Arsenal Preset
...
GRLIB_arsenal_weapons = [
    ...
    "rhs_weap_ak103_1_npz",                                         // AK-103 (B-13)
    "rhs_weap_ak103_2",												// AK-103-2
    "rhs_weap_ak103_2_npz",                                         // AK-103-2 (B-13)
    "rhs_weap_103_npz",                                      		// AK-103 (B-13)
    "rhs_weap_ak103_gp25",                                      	// AK-103 (GP-25)
    "rhs_weap_ak103_gp_25_npz",                                     // Ak-103 (GP-25/B-13)
    "rhs_weap_ak103_zenitco01",                                     // AK-103 (Zenitco)
    "rhs_weap_ak103_zenitco01_b33",                                 // AK-103 (Zentico/B-33)
    ...
    "rhs_weap_ak105_zenitco01_b33",                                 // AK-105 (Zenitco/B-33)
    "rhs_weap_ak74",                                     			// AK-74
    "rhs_weap_ak74_gp25",                                          	// AK-74 (GP-25)
    "rhs_weap_ak74_3",                                              // AK-74 (Green)
    "rhs_weap_ak74_2",                                              // AK-74 (Plum)
    ...
    "rhs_weap_ak74n_2_gp25",                                        // AK-74N (Plum/GP-25)
    "rhs_weap_ak74n_2_gp25_npz",                                    // AK-74N (Plum/GP-25/B-13)
    "rhs_weap_akm",                                             	// AKM
    "rhs_weap_akm_gp25",                                           	// AKM (GP-25)
    "rhs_weap_akm_zenitco01_b33",                                   // AKM (Zenitco/B-33)
    "rhs_weap_akmn",                                             	// AKMN
    "rhs_weap_akmn_gp25",                                           // AKMN (GP-25)
    "rhs_weap_akmn_gp25_npz",                                       // AKMN (GP-25/B-13)
    "rhs_weap_akmn_npz",                                     		// AKMN (B-13)
    "rhs_weap_akms",                                      			// AKMS
    "rhs_weap_akms_gp25",                                 			// AKMS (GP-25)
    "rhs_weap_aks74",                                  				// AKS-74
    "rhs_weap_aks74_gp25",                                 			// AKS-74 (GP-25)
    "rhs_weap_aks74_2",                                    			// AKS-74 (Plum)
    "rhs_weap_aks74n",                                				// AKS-74N
    "rhs_weap_aks74n_gp25",                                 		// AKS-74N (GP-25)
    "rhs_weap_aks74n_gp25_npz",                                		// AKS-74N (GP-25/B-13)
    "rhs_weap_aks74n_npz",                                   		// AKS-74N (B-13)
    "rhs_weap_aks74n_2",                                     		// AKS-74N (Plum)
    "rhs_weap_aks74n_2_npz",                                        // AKS-74N (Plum/B-13)
...
GRLIB_arsenal_magazines = [
    ...
    "rhs_100Rnd_752x54mmR",                                         // 100rnd PKM 57-N-323S
    "rhs_100Rnd_752x54mmR_7BZ3",                                    // 100rnd PKM 7BZ-3
    "rhs_100Rnd_762x54mmR_7N13",                                    // 100rnd PKM 7N13
    "rhs_100Rnd_762x54mmR_7N26",                                    // 100rnd PKM 7N26
    "rhs_100Rnd_762x54mmR_green",                                   // 100rnd PKM 7T2 (Tracer)
    "rhs_10Rnd_762x39mm",                                           // 10rnd AK-103 57-N-231
    "rhs_10Rnd_762x39mm_89",                                        // 10rnd AK-103 57-N-231(89)
    "rhs_10Rnd_762x39mm_tracer",                                    // 10rnd AK-103 57-N-231 (Tracer)
    "rhs_10Rnd_762x39mm_U",                                         // 10rnd AK-103 57-N-231 (Subsonic)
    "rhs_10rnd_9x39mm_SP5",                                         // 10rnd AS Val SP-5
    "rhs_10rnd_9x39mm_SP6",                                         // 10rnd AS Val SP-6
    "rhs_10Rnd_762x54mmR_7N1",                                      // 10rnd SVD 7N1
    "rhs_10Rnd_762x54mmR_7n14",                                     // 10rnd SVD 7N14
    "rhs_20rnd_9x39mm_SP5",                                         // 20rnd AS Val SP-5
